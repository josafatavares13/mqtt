...
TOPIC_CARREGADOR_SOLAR02 = config['mqtt']['topics7']
...
def subscribe(client: mqtt.Client):
    values = {topic: None for topic in TOPIC_CARREGADOR_SOLAR02}
    ...
    def on_message(client, userdata, msg):
        ...
        if all(values.values()):
            try:
                ...
                corrente_pv_solarcharger2 = values[TOPIC_CARREGADOR_SOLAR02[0]] / values[TOPIC_CARREGADOR_SOLAR02[1]]
                postgresql_insert_query = f"INSERT INTO carregador_solar02 (potencia_pv_solarcharger2, tensao_pv_solarcharger2, corrente_pv_solarcharger2) VALUES ({values[TOPIC_CARREGADOR_SOLAR02[0]]}, {values[TOPIC_CARREGADOR_SOLAR02[1]]}, {corrente_pv_solarcharger2})"
    ...
    print('Carregador solar 02')
    for topic in TOPIC_CARREGADOR_SOLAR02:
